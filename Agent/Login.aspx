<%@ Page Language="C#"   AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Jewar_API.Login" %>

<!DOCTYPE html>
<html dir="ltr" lang="en">

<!-- Mirrored from creativelayers.net/themes/homez-html/page-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 10 Nov 2023 07:05:57 GMT -->
<head>
<meta charset="utf-8">
          ...
          <div class="col-lg-6">
            <div class="log-reg-form signup-modal form-style1 bgc-white p50 p30-sm default-box-shadow2 bdrs12">
              ...
              <div class="mb25">
                ...
                <input type="email" class="form-control" placeholder="Enter Email" id="txtEmail1" >
              </div>
              <div class="mb15">
