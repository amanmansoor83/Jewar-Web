<%@ Page Language="C#" MasterPageFile="~/Agent/Agent.Master" AutoEventWireup="true" CodeBehind="Dashboard.aspx.cs" Inherits="Jewar_API.Dashboard" %>
        ...
        <div class="col-sm-6 col-xxl-3">
            <div class="d-flex justify-content-between statistics_funfact">
                <div class="details">
                    ...
                    <div class="title"><%=AllProperties%></div>
                </div>
        ...
        <div class="col-sm-6 col-xxl-3">
            <div class="d-flex justify-content-between statistics_funfact">
                <div class="details">
                    ...
                    <div class="title"><%=TotalViews%></div>
                </div>
        ...
        <div class="col-sm-6 col-xxl-3">
            <div class="d-flex justify-content-between statistics_funfact">
                <div class="details">
                    ...
                    <div class="title"><%=TotalVisitorReviews%></div>
                </div>
        ...
        <div class="col-sm-6 col-xxl-3">
            <div class="d-flex justify-content-between statistics_funfact">
                <div class="details">
                    ...
                    <div class="title"><%=TotalFavourites%></div>
                </div>
