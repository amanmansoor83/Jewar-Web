<%@ Page Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="detail.aspx.cs" Inherits="Jewar_API.detail" %>


<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="body_content">
        <!-- Property All Lists -->
        <section class="pt60 pb60 bgc-white">
         <%--   <div class="container">
                ...
                <div class="tab-content overflow-visible" id="pills-tabContent2">
                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                        <div class="container">
                            <div class="row wow fadeInUp" data-wow-delay="300ms">
                                <div class="col-lg-12">
                                    <div class="ps-v4-hero-slider dots_none slider-dib-sm slider-1-grid vam_nav_style owl-theme owl-carousel">
                                        <asp:Repeater ID="rptPropertyImages" runat="server">
                                            <ItemTemplate>

                                                <div class="item">
                                                    <img class="bdrs12" src="<%#Eval("ImageURL") %>" alt="">
                                                </div>
                                            </ItemTemplate>
                                        </asp:Repeater>

                                        <%-- <div class="item">
                                            <img class="bdrs12" src="images/listings/listing-single-slide2.jpg" alt="">
                                        </div>
                                        <div class="item">
                                            <img class="bdrs12" src="images/listings/listing-single-slide3.jpg" alt="">
                                        </div>--%>
                                    </div>
                                </div>
                            </div>
        ...
        <!-- Property All Lists -->
        <section class="pt0 pb90 bgc-white">
            <div class="container">
                    ...
                    <div class="col-lg-8">
                        <div class="single-property-content mb30-md">
                            ...
                            <div class="pd-meta mb15 d-md-flex align-items-center">
                                <p class="text fz15 mb-0 pr10 bdrrn-sm"><%=Address %></p>
                            </div>
                            <div class="property-meta d-flex align-items-center">
                                <a class="ff-heading text-thm fz15 bdrr1 pr10 bdrrn-sm" href="#"><i class="fas fa-circle fz10 pe-2"></i>For <%=Listed %></a>
                                <a class="ff-heading bdrr1 fz15 pr10 ml10 ml0-sm bdrrn-sm" href="#"><i class="far fa-clock pe-2"></i> <%=Created  %> <%--1 years ago--%></a>
                ...
                <div class="row wrap mt50 wow fadeInUp" data-wow-delay="500ms">
                    <div class="col-lg-8">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <div class="pd-list">
                                        ...
                                        <p class="text mb-0">
                                            <i class="fas fa-circle fz6 align-middle pe-2"></i>
                                            WiFi6<p>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div class="accordion-item">
                                                ...
                                                <div id="collapseFirst" class="accordion-collapse collapse" aria-labelledby="headingFirst" data-parent="#accordionExample">
                                                    <div class="accordion-body text-center">
                                                        <img class="w-100" src="images/listings/listing-single-1.png" alt=""></div>
                                                </div>
                                            </div>
